        ...
        with st.spinner("Downloading model (first run only)..."):
            ...
            try:
                ...
                try:
                    ...
                    st.success("Model downloaded using alternative method!")
                except:
                    st.error("All download methods failed. Please check the URL.")
                    return None
